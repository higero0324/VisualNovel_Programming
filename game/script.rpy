...
image shiori tired = im.Scale(im.Composite((500, 900), (0, 0), "shiori_tired.png"),600,1080)
image shiori sleep = im.Scale(im.Composite((500, 900), (0, 0), "shiori_sleep.png"),600,1080)
image shiori hawawa = im.Scale(im.Composite((500, 900), (0, 0), "shiori_hawawa.png"),600,1080)
image shiori lunatic = im.Scale(im.Composite((500, 900), (0, 0), "shiori_luna.png"),600,1080)
image baba = "baba.png"
image baba happy= "baba_h.png"
image Aend1 = "A end 1.png"
image Aend2 = "A end 2.png"
image True end = "True end.png"
image bg my world = im.Scale("images/myworld.png",1600,1200)
image white = im.Scale("images/white.png",1600,1200)
